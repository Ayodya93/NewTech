            ...
            <div class="col-12">
                <div class="row">
                    ...
                    <nav class="navbar navbar-expand-lg bg-light">
                        <div class="container-fluid">
                            <span class="form-label fs-2 fw-bold text-dark">Update Product <i class="bi bi-bag-plus-fill fs-2"></i></span>
                            ...
                            <div class="collapse navbar-collapse offset-1" id="navbarSupportedContent">
                                ...
                                <form class="d-flex" role="search">
                                    <a href="cart.php" class="btn btn-outline-light" type="submit"><i class="bi bi-cart4 fs-2 text-dark"></i></a>
                                </form>
                            </div>
                        </div>
                    </nav>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="form-check form-check-inline col-4 offset-1">
                                                    <input class="form-check-input" type="radio" name="c" disabled checked/>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="row">
                                                    ...
                                                    <div class="form-check form-check-inline col-4 offset-1">
                                                        <input class="form-check-input" type="radio" name="c1" disabled/>
                                                    ...
                                                    <div class="form-check form-check-inline col-4">
                                                        <input class="form-check-input ch" type="radio" name="c1" disabled checked/>
